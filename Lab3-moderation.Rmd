...
Download repository here: https://github.com/garberadamc/SEM-Lab3
...
knitr::include_graphics(here("figures", "lab3_model1.png"))
```
...
knitr::include_graphics(here("figures", "Lab3_model2.png"))
```
